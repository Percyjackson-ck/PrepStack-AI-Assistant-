...
echo "   - Build command: npm run build (builds both frontend & backend)"
...
echo ""
echo "3️⃣  MANUAL FRONTEND DEPLOYMENT (Only if needed separately):"
...
echo ""
echo "🔑 Environment Variables for Vercel (if deploying frontend separately):"
echo "   VITE_API_URL=https://your-digitalocean-app.ondigitalocean.app"
echo ""
echo "📱 Quick Start for DigitalOcean App Platform (Full-Stack):"
...
echo ""
echo "✅ Single deployment - frontend and backend served together!"
