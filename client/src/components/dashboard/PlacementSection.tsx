  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap gap-4">
              <Select value={filters.company} onValueChange={(value) => setFilters(prev => ({ ...prev, company: value === 'All Companies' ? '' : value }))}>
              ...
              <Select value={filters.year} onValueChange={(value) => setFilters(prev => ({ ...prev, year: value === 'All Years' ? '' : value }))}>
              ...
              <Select value={filters.difficulty} onValueChange={(value) => setFilters(prev => ({ ...prev, difficulty: value === 'All Difficulties' ? '' : value }))}>
                <SelectTrigger className="w-40">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                {filteredQuestions.slice(0, 10).map((question: any) => (
        ...
        {/* Practice Stats & Recommendations */}
        <div className="space-y-6">
          {/* Practice Progress */}
          <Card>
            <CardContent className="p-6">
