...
export function NotesSection() {
  ...
  const subjects = ['All', 'DBMS', 'Computer Networks', 'Operating Systems', 'OOPS', 'SQL', 'Data Structures', 'Algorithms'];
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredNotes.map((note: any) => (
                  <div key={note.id} className="border border-gray-200 dark:border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                      ...
                      <span className="bg-secondary/10 text-secondary px-2 py-1 rounded-full">PDF</span>
                    </div>
                  </div>
                ))}
              </div>
